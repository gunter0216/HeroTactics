...
{
    public class BattlesConfig
    {
        private readonly int m_Width;
        private readonly int m_Height;
        private readonly int[][] m_UnitPositions;
        private readonly List<BattleConfig> m_Battles;
        ...
        public BattlesConfig(BattleDto dto)
        {
            ...
            m_Battles = new List<BattleConfig>(dto.Battles.Length);
            foreach (var battleDto in dto.Battles)
            {
                m_Battles.Add(new BattleConfig(battleDto));
            }
        }
    }
}
